# ==============================================================================
# Type-I error/level simulation for two-sample proportion tests
# ------------------------------------------------------------------------------
...
run_combined_simulation <- function(theta_values, n, B, eps = 1, H = 1000, alpha = 0.05, seed) {
...
analyze_results <- function(sim_results) {
  ...
  theta_stats <- sim_results %>%
    ...
    summarise(
      empirical_level = mean(rejected),
      level_se = sd(rejected)/sqrt(n()),
...
combined_results <- run_combined_simulation(

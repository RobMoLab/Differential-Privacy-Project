...
for (j in 1:length(n1)){
  ...
  for (i in 1:H){
    ...
    emp_density_NPJ = jini2samples_fiducial_NP(pi1 = pi1, pi2 = pi2, B = B, n1 = n1[j], n2 = n2[j], seed = i + 2*B)
...
apply(res_Normal_app2 < 0.01, 2, mean, na.rm = TRUE)
apply(res_np2 < 0.01, 2, mean, na.rm = TRUE)
apply(res_PJ2< 0.01, 2, mean, na.rm = TRUE)
apply(res_NPJ2 < 0.01, 2, mean, na.rm = TRUE)


apply(res_Normal_app2 < 0.05, 2, mean, na.rm = TRUE)
apply(res_np2 < 0.05, 2, mean, na.rm = TRUE)
apply(res_PJ2< 0.05, 2, mean, na.rm = TRUE)
apply(res_NPJ2 < 0.05, 2, mean, na.rm = TRUE)


apply(res_Normal_app2 < 0.1, 2, mean, na.rm = TRUE)
apply(res_np2 < 0.1, 2, mean, na.rm = TRUE)
apply(res_PJ2< 0.1, 2, mean, na.rm = TRUE)
apply(res_NPJ2 < 0.1, 2, mean, na.rm = TRUE)

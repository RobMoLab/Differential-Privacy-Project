...
#pdf("Power_Two_sample_Private_JINI.pdf")  # Save plot as PDF on Auburn HPC
plot(n1, power_res_PJ2, type = "b", pch = 19, col = "blue", xlab = "sample size", ylab = "Power", ylim = c(0,1), main = "Power of JINI Two Samples Private Test (H=10^3, B=10^3, eps=1)")
